        ...
        return {
            ...
            "mailbox": {
                ...
                "allow_insecure_plaintext_login": (
                    self.mailbox.allow_insecure_plaintext_login
                ),
...
def _mailbox_from(value: object) -> MailboxSettings:
    ...
    return MailboxSettings(
        ...
        allow_insecure_plaintext_login=(
            value.get("allow_insecure_plaintext_login") is True
        ),
...
def validate(config: Config) -> List[Finding]:
    ...
    if mailbox.adapter == "none":
        ...
        if not mailbox.ssl:
            if mailbox.allow_insecure_plaintext_login:
                findings.append(
                    Finding(
                        "warning",
                        "mailbox.allow_insecure_plaintext_login is active: "
                ...
                findings.append(
                    Finding(
                        ...
                        "mailbox.allow_insecure_plaintext_login.",
                    )
                )
